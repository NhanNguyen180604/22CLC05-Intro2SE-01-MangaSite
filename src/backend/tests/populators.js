...
//   return (await categoryModel.find({ name: { $in: names } }).select("_id")).map(
//     (node) => node._id,
//   );
// }
...
//   const authors = ["Mario", "Luigi", "Peach", "Daisy", "Yoshi", "Bowser"].map(
//     (author) => ({ name: author }),
//   );
...
//       description:
//         "A twoself-biography about how a fat Italian man flies through zero gravity to save a princess.",
//       status: "In progress",
...
//       description:
//         "Two young girls travel a multiverse of destroyed civilizations, gathering what remains from memory fragments.",
//       status: "In progress",
...
//     { name: "strawberry" },
//     { blacklist: { categories: await mapCategoriesToId("Yoshi") } },
//   );
//   await userModel.updateOne(
//     { name: "blueberry" },
//     { blacklist: { authors: await mapAuthorsToId("Peach") } },
//   );
// }
...
//       content:
//         "Wow luna didn't draw HK well, given that she loves procreate that much.",
//     },
//     {
...
//       comment: (
//         await getCommentByContent("Yo! I managed to get a lot of money back!")
//       )._id,
//     },
//     {
