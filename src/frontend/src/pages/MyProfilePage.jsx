	...
	return (
		<MainLayout>
			...
			<form className="mt-6 mx-auto w-full px-4" onSubmit={handleSave}>
                ...
                >
                    <img
                        src={previewAvatar ? previewAvatar : form.avatar?.url}
                        alt="Avatar"
                ...
                <div className="mt-8 flex flex-col items-center space-y-4">
                    <button
                        type="submit"
                        className={`w-full max-w-xl py-2 px-6 rounded-3xl ${
                            saving ? "bg-gray-500 cursor-not-allowed" : "bg-blue hover:bg-light-blue"
                        } text-white`}
                        disabled={saving}
                    >
